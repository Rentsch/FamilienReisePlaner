...
import { AppointmentModal, type AppointmentInitial } from "./AppointmentModal";
  ...
  return (
    <main className="mx-auto w-full max-w-2xl flex-1 px-6 pt-6 pb-10">
      ...
      <div className="mb-4 flex items-center justify-between gap-3">
        <h1 className="text-2xl font-semibold text-foreground">Tagesablauf</h1>
        <div className="flex shrink-0 gap-2">
          ...
          <AppointmentModal
            ...
            onSubmit={(formData) => createAppointment(tripId, formData)}
            trigger={(open) => (
              <button
                onClick={open}
      ...
      {exportError && <p className="mb-4 text-xs text-red-600 dark:text-red-400">{exportError}</p>}
                ...
                >
                  ...
                  <div data-export-hide className="flex shrink-0 gap-1">
                    <AppointmentModal
                      ...
                      onSubmit={(formData) => updateAppointment(tripId, appointment.id, formData)}
                      trigger={(open) => (
                        <button
                          onClick={open}
                    ...
                    />
                    <ConfirmDeleteButton
                      action={() => deleteAppointment(tripId, appointment.id)}
